...
[Example 2: Solve y = x**2 (r2 from 0.00 to 0.94:](../old_versions/example2.pdf)<p>
[Example 3: Solve 2 different ln functions (r2 from 0.646 to 0.997:](../old_versions/example3.pdf)<p>
[Example 4: Solve dataset with 200 observations and 3 features (r2 from 0.8972 to 0.973:](../old_versions/example4.pdf)<p>
[Example 5: Solve (with recursion) a cubic function y = -x**3 +5x (r2 from 0.079 to 0.984:](../old_versions/example5.pdf)<p><p>
